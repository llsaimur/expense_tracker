...
//we render a pie chart for the avg expense incurred per category in the given month
    //also add two DatePicker components to allow usrs to select date and retrieve data for that date with btn click
...
export default function Reports() {
    ...
    //retrieve intial avg expense data
    useEffect(() => {
    ...
    //we render data in a Victory Pie chart

    //to render the pie chart with seperate center label,
        //place VictoryPie componenet in an svg element, alowing us to customize the pie chart wrapping and a seperate circular label
            //using VictoryLabel outside the pie chart code...

    //we pass the data to VictoryPie, define customized labels for each slice 
        //and make the pie chart standalone so the center label can be placed over the chart
    return (
      <div>
