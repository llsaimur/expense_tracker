...
//media streaming
//initialize a new GridFSBucket with this db connection after established
    //the gridfs obj created allows us access to GridFS functionalites
        //which we use to store video file when new media is created
            //as well as to fetch file when media is being streamed by a user
